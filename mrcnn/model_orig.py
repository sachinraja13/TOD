...
def rpn_bbox_structural_continuity_loss_graph(roi_box_coordinate,
    ...
    gt_pairwise_start_end_x_differences = gt_pairwise_start_end_x_differences * \
        col_continuity_segments * mask_pairwise
    pairwise_start_end_x_differences = pairwise_start_end_x_differences * \
        col_continuity_segments * mask_pairwise
    gt_pairwise_start_end_y_differences = gt_pairwise_start_end_y_differences * \
        row_continuity_segments * mask_pairwise
    pairwise_start_end_y_differences = pairwise_start_end_y_differences * \
        row_continuity_segments * mask_pairwise

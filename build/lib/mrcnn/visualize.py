...
def display_instances(image_name,
                      image,
                      boxes,
                      masks,
                      class_ids,
                      ...
                      colors=None,
                      captions=None,
                      dataset_path='trained_model/coco'):
    '''
    ...
    '''
    path = dataset_path + "/result_text/"
    text_file_name = image_name.replace(".jpg", ".txt")
    file_path = path + text_file_name
    ...
    for i in range(N):
        ...
        if not captions:
            ...
            caption = "{} {:.7f}".format(label, score) if score else label
        else:
            caption = captions[i]
        ax.text(x1,
                y1 + 8,
        ...
        if weights is not None:
            ...
            f.write(" ")
            f.write(str(weights[i, 1]))
            f.write(" ")
            f.write(str(weights[i, 2]))
            f.write(" ")
            f.write(str(weights[i, 3]))
            f.write("\n")
